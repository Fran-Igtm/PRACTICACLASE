...
mongoose.connect('mongodb://isen:dwes@contenedordesdedockercompose:27017/miapp?authSource=admin') //indicar a mongoose donde se tiene que conectar...miapp es la base de datos donde vamos a escribir, y auth es el nivel de autorizacion
